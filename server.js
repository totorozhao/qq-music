...
async function fetchHandle(url, res) {
  try {
...
//搜索结果 注意需要encodeURIComponent 编码
...
app.get('/lyrics', async(req, res) => {
  ...
  const url = `https://c.y.qq.com/lyric/fcgi-bin/fcg_query_lyric.fcg?nobase64=1&musicid=${id}&songtype=${type || 0}&callback=jsonp1`
  try {
